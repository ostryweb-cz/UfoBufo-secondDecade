...
- ✅ **Using WordPress defaults only** - Gallery templates use `'medium'` size (300x300 by default)
- ✅ **Stage images use full size** - `ufobufo_get_stage_image_html()` uses `'full'` size for maximum quality
